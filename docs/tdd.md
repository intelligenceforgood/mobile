...
> **Status:** Accepted — prototype shipped 2026-04-22.
> **Audience:** the developer implementing the prototype.
> **Prereqs read:** [prd_mobile_prototype.md](../../planning/prd_mobile_prototype.md), [architecture.md](./architecture.md).
...
| Telemetry          | `@sentry/react-native` (opt-in)                          | 8.x                    | Cross-platform; disabled when `config.sentryDsn` is empty (e.g., `local`).                                                                                   |
...
Next: see [developer-guide.md](./developer-guide.md) for day-in-the-life workflow.
